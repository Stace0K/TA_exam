...
class OperationsHelper(BasePage):
    ...
    def enter_passwd(self, word):
        self.enter_text_into_field(TestSearchLocators.ids['LOCATOR_PASSWD_FIELD'], word, description='password')

    def get_enter_login(self):
        return self.get_text_from_element(TestSearchLocators.ids['LOCATOR_ENTER'], description='enter')
    ...
    def font_size(self):
        return self.get_element_property(TestSearchLocators.ids['LOCATOR_ABOUT_HEADER'], property='font-size')
